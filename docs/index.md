...
<div class="pathway-grid">
    <div class="step-card">
        ...
        <p>A variety of toys ranging in play styles (bubbles, light and sound, etc.) with step by step instructions on how to adapt them to be switch accessible.</p>
        <ul>
    ...
    <div class="step-card">
        ...
        <p>Resources to help learn about toy adapting.</p>
        <ul>
