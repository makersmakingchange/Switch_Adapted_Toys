...
toy_purchase_link: https://www.walmart.ca/en/ip/Spinning-Light-Wand/6000201173988          # adds a "Where to Buy This Toy" button if filled in
toy_purchase_link_alt:      # adds a 2nd purchase button if there's another link
general_notes: beginner adaptation, can purchase in store at Walmart               # any general notes, e.g. "Uses lots of screws."
device_uid: DEV-10144                 # internal MMC use only - never shown on the site
