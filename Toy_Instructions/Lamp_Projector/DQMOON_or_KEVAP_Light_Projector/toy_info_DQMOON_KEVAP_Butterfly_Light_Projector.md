...
toy_purchase_link: https://a.co/d/dL4bDjU          # adds a "Where to Buy This Toy" button if filled in
toy_purchase_link_alt:      # adds a 2nd purchase button if there's another link
general_notes: moderate multiple solder points, instructions in English and French               # any general notes, e.g. "Uses lots of screws."
